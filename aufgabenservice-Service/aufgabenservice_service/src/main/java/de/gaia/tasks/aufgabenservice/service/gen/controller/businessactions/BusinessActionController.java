package de.gaia.tasks.aufgabenservice.service.gen.controller.businessactions;
...
public class BusinessActionController implements ResourceProcessor<RepositoryLinksResource> {
	...
	@Autowired
	MitarbeiterInformieren_BusinessActionService mitarbeiterInformierenactionService;
	@Autowired
    ...
    public List<Link> getMethodActions() {
		...
		methodLinks.add(new Link(base + "/mitarbeiterInformieren", "mitarbeiterInformieren"));
	 ...
	 */
	@RequestMapping(value = "/mitarbeiterInformieren", method = RequestMethod.GET)
	public ResponseEntity<?> mitarbeiterInformieren(PersistentEntityResourceAssembler assembler)
	{	
		mitarbeiterInformierenactionService.mitarbeiterInformieren();
		return new ResponseEntity<>(HttpStatus.OK);
	}
