...
/**
 * Provides a simple Form for creating a new Mitarbeiter_.
 *
 * @author claus.straube p.mueller
 * @version 2.0
 */
public class Mitarbeiter_CreateForm extends Mitarbeiter_Form {
	...
	/**
	 * Create a new Mitarbeiter_CreateForm that navigates to the navigateTo View on save.
	 *
	 * @param navigateTo The String of the view to navigate to on save.
	 */
    public Mitarbeiter_CreateForm(final String navigateTo) {
	...
	protected void configureSaveButton() {
        Mitarbeiter_SingleActions mitarbeiterSingleActions = new Mitarbeiter_SingleActions(this::getMitarbeiter);
        getSaveButton().addActionPerformer(mitarbeiterSingleActions::create);
	...
	public Mitarbeiter_ getMitarbeiter(){
		Mitarbeiter_ mitarbeiter=super.getMitarbeiter();
		return mitarbeiter;
	}
